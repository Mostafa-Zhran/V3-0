                ...
                {displayedProjects.map((project, i) => (
                  ...
                  >
                    ...
                    <div className={`lg:col-span-5 p-8 lg:p-12 flex flex-col justify-center bg-black/40 backdrop-blur-md z-20 ${i % 2 !== 0 ? 'lg:order-1' : ''}`}>
                      ...
                      <p className="text-white/60 text-base leading-relaxed mb-8 flex-1 line-clamp-4">
                        {project.desc}
                      </p>
                      ...
                      <div className="flex flex-wrap gap-2 mb-10">
                        ...
                        {project.tags.length > 5 && (
                          <span className="px-3 py-1.5 text-xs font-medium text-white/50 bg-white/5 border border-white/10 rounded-full">
                      ...
                      <div className="flex items-center gap-4 mt-auto flex-wrap">
                        ...
                        <motion.button
                          ...
                          className="relative inline-flex items-center justify-center gap-2 px-6 py-3 bg-saas-purple text-white text-sm font-bold rounded-xl shadow-[0_6px_0_0_#4c1d95] hover:shadow-[0_8px_0_0_#4c1d95,0_0_20px_rgba(139,92,246,0.5)] transition-all duration-200 group/btn"
                        >
                          <span className="absolute inset-0 w-full h-full bg-white/20 rounded-xl opacity-0 group-hover/btn:opacity-100 transition-opacity" />
                          <Eye size={15} className="relative" />
                        ...
                        {project.link && project.link !== "#" && (
                          <motion.a
                            ...
                            whileHover={{ y: -3 }}
                            whileTap={{ scale: 0.97 }}
                            className="inline-flex items-center gap-2 px-5 py-3 bg-white/5 border border-white/10 hover:bg-white/10 text-white/70 hover:text-white rounded-xl text-sm font-medium transition-all"
                          >
